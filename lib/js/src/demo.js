...
var updateSeed = Random.init;

Arg.parse(/* :: */[
      /* tuple */[
        "-seed",
        /* Int */Block.__(6, [updateSeed]),
...
function print_string_ln(str) {
  return Pervasives.print_string(str + "\n");
}
...
function logOutput(net) {
  ...
  return $$Array.mapi((function (ind, layer) {
                var str = "Layer " + Pervasives.string_of_int(ind);
...
function logWeights(net) {
  $$Array.mapi((function (ind, layer) {
          ...
          Pervasives.print_string(str + "\n");
          return $$Array.map((function (perc) {
                        var str = $$Array.fold_left((function (soFar, weight) {
                                return soFar + " " + Pervasives.string_of_float(weight);
                              }), "", perc[/* weights */2]);
                        return Pervasives.print_string(str + "\n");
                      }), layer);
        }), net[/* perceptrons */0]);
...
function logLinearObj(obj, indent) {
  if (obj.tag) {
    return $$Array.iteri((function (ind, innerObj) {
                  var str = leftPad(Pervasives.string_of_int(ind), indent);
                  Pervasives.print_string(str + "\n");
                  return logLinearObj(innerObj, indent + 2 | 0);
                }), obj[0]);
  } else {
    var str = leftPad($$Array.fold_left((function (output, x) {
...
function trainMiniBatch(net, data) {
  ...
  if (errorData) {
    ...
    var newVelocity = match ? linearClip(net[/* config */1][/* gradientClip */1], linearAdd(linearScalarProd(match[0], net[/* config */1][/* gamma */4]), linearScalarProd(weightDerivs, (1.0 - net[/* config */1][/* gamma */4]) * net[/* config */1][/* alpha */9] / net[/* config */1][/* batchSize */5]))) : linearClip(net[/* config */1][/* gradientClip */1], linearScalarProd(weightDerivs, net[/* config */1][/* alpha */9]));
...
function trainEpoch(net, data) {
  ...
  if (error < net[/* error */3]) {
    net[/* config */1][/* alpha */9] = net[/* config */1][/* alpha */9] * net[/* config */1][/* decreasedErrorAlpha */6];
  } else {
    net[/* config */1][/* alpha */9] = Pervasives.max(net[/* config */1][/* alpha */9] * net[/* config */1][/* increasedErrorAlpha */7], net[/* config */1][/* minAlpha */8]);
  }
  net[/* error */3] = error;
  return error;
}
...
function trainNetwork(net, data) {
  ...
  while(epochs < net[/* config */1][/* maxEpochs */2] && error > net[/* config */1][/* targetError */3]) {
    ...
    epochs = epochs + 1 | 0;
    error = thisError;
    var str = "Epoch " + Pervasives.string_of_int(epochs) + ": error is " + Pervasives.string_of_float(error) + "; Alpha is " + Pervasives.string_of_float(net[/* config */1][/* alpha */9]);
    Pervasives.print_string(str + "\n");
  };
  return net;
}
...
var myNet = makeNetwork(config, tanhAct, /* :: */[
      5,
      /* :: */[
        10,
        /* :: */[
...
exports.print_string_ln            = print_string_ln;
